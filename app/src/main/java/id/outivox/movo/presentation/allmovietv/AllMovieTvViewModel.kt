...
class AllMovieTvViewModel(
    private val allMovieTvUseCase: AllMovieTvUseCase
) : ViewModel() {
    ...
    fun getMoviesByCategory(category: String, page: String = "1"){
        val source = allMovieTvUseCase.getMovies(category, page).toLiveData()
    ...
    fun getTvByCategory(category: String, page: String = "1"){
        val source = allMovieTvUseCase.getTvShow(category, page).toLiveData()
